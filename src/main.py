...
# Add callback to sync the radio buttons to the store
@app.callback(
...
# Update the handle_node_tap to use the store
# In handle_node_tap, change State("edge-type", "value") to State("edge-type", "data")
